...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/server/auth
---
...
* [`sfp server auth login`](auth.md#sfp-server-auth-login) - Authenticate with the SFP server
* [`sfp server auth display`](auth.md#sfp-server-auth-display) - Display authentication token information
* [`sfp server auth list`](auth.md#sfp-server-auth-list) - List all auth tokens stored locally
* [`sfp server auth clear`](auth.md#sfp-server-auth-clear) - Clear all local authentication tokens
