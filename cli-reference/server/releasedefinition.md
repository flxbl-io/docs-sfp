...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/server/releasedefinition
---
...
* [`sfp server releasedefinition generate`](releasedefinition.md#sfp-server-releasedefinition-generate) - Generate a release definition and publish to server
