...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/server/environment
---
...
* [`sfp server environment create`](environment.md#sfp-server-environment-create) - Create a new environment
* [`sfp server environment list`](environment.md#sfp-server-environment-list) - List environments with filtering options
* [`sfp server environment get`](environment.md#sfp-server-environment-get) - Get detailed environment information
* [`sfp server environment lock`](environment.md#sfp-server-environment-lock) - Lock environment for exclusive access
* [`sfp server environment unlock`](environment.md#sfp-server-environment-unlock) - Unlock environment
* [`sfp server environment delete`](environment.md#sfp-server-environment-delete) - Delete an environment
