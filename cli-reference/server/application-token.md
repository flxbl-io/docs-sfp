...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/server/application-token
---
...
* [`sfp server application-token create`](application-token.md#sfp-server-application-token-create) - Create a new application token
* [`sfp server application-token list`](application-token.md#sfp-server-application-token-list) - List all application tokens
* [`sfp server application-token revoke`](application-token.md#sfp-server-application-token-revoke) - Revoke an application token
