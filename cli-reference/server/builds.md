...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/server/builds
---
...
* [`sfp server builds list`](builds.md#sfp-server-builds-list) - List recent builds sorted by commit time
