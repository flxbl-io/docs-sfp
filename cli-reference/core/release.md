...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/cli-reference/core/release
---
...
_See code:_ [_src/commands/release.ts_](https://github.com/flxbl-io/sfp/blob/v37.0.1/src/commands/release.ts)
