...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/auth-management/community-edition
---
...
See [Scratch Org Pool Authentication](https://github.com/flxbl-io/docs-sfp/blob/main/authentication/scratch-org-pools.md) for details.
...
3. [Register your orgs](https://github.com/flxbl-io/docs-sfp/blob/main/authentication/org-registration.md)
4. [Create environments](https://github.com/flxbl-io/docs-sfp/blob/main/authentication/environments.md)
...
* [Scratch Org Pools](https://github.com/flxbl-io/docs-sfp/blob/main/authentication/scratch-org-pools.md) - Pool authentication
