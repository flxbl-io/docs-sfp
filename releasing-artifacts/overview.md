...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/releasing-artifacts/overview
---
...
sfp uses [Release Configs](../development/defining-a-domain/release-config.md) to organize packages by domain. These configs define which packages belong to a domain and control various aspects of the release process:
