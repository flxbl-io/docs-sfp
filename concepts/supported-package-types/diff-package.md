...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/concepts/supported-package-types/diff-package
---

# Diff Package

A diff package is a variant of '[source package](https://github.com/flxbl-io/docs-sfp/blob/main/concepts/supported-package-types/broken-reference/README.md)' , where the contents of the package only contain the components that are changed. This package is generated by sfpowerscripts by computing a `git diff` of the current commit id against a baseline set in the Dev Hub Org
