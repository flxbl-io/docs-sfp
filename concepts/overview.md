...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/concepts/overview
---
...
### [**Releasing a domain**](../releasing-artifacts/overview.md)

Releasing a domain involves the process of promoting, installing a collection of artifacts to a higher org such as production, generating an associated changelog for the domain. This process is driven by the release command along with a [release definition](../releasing-artifacts/release-definitions.md).
