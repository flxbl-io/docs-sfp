...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/configuring-a-project/project-structure
---

# Project structure

<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>A sample repository structure used with sfp<br><br></p></figcaption></figure>
...
5. **src-env-specific:** An [aliasified package ](https://github.com/flxbl-io/docs-sfp/blob/main/configuring-a-project/broken-reference/README.md)which carries metadata for each particular stage (environment) of your path to production. Some examples include named credentials, remote site settings, web links, custom metadata, custom settings, etc.
