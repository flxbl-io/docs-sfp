...
* [Installing SFP Server](running-sfp-as-a-server/installing-sfp-server/README.md)
  ...
  * [Setting up SFP Server on EC2](running-sfp-as-a-server/installing-sfp-server/setting-up-sfp-server-on-ec2/README.md)
    * [Docker Installation](running-sfp-as-a-server/installing-sfp-server/setting-up-sfp-server-on-ec2/docker-installation.md)
