...
* [Server Management Commands](cli-reference/server/README.md)
  * [Lifecycle Management](cli-reference/server/README.md)
  ...
  * [Monitoring & Operations](cli-reference/server/README.md)
    * [Health](cli-reference/server/health.md)
    * [Logs](cli-reference/server/logs.md)
    * [Scale](cli-reference/server/scale.md)
  * [Configuration & Management](cli-reference/server/README.md)
  ...
  * [Resources & Data](cli-reference/server/README.md)
