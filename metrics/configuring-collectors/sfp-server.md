...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/YLI5Ts7pWhWQV9UaBn3H/metrics/configuring-collectors/sfp-server
---
...
* sfp server running (see [Server Setup](../../cli-reference/server/))
...
To create an application token for your CI/CD pipeline, see [Application Tokens](https://github.com/flxbl-io/docs-sfp/blob/main/auth-management/application-tokens.md).
